    ...
    <div className="space-y-3">
      <div ref={cardRef} className="card relative overflow-hidden">
        ...
        <div className="h-32 w-full">
          <ResponsiveContainer>
            <BarChart data={voteData} layout="vertical" margin={{ left: -20, right: 20 }}>
              ...
              <Bar dataKey="count" radius={[0, 4, 4, 0]} barSize={20}>
                {voteData.map((_, i) => (
                  <Cell key={i} fill={i % 2 === 0 ? "#38bdf8" : "#818cf8"} />
                ))}
              </Bar>
            </BarChart>
          </ResponsiveContainer>
      ...
      <div className="flex gap-2 px-2">
        ...
        <button
          onClick={() =>
            navigator.share?.({ title: "Spitfact", text: poll.question, url: window.location.href })
          }
          className="flex-1 btn-secondary py-2 text-[10px] flex items-center justify-center gap-2"
        >
